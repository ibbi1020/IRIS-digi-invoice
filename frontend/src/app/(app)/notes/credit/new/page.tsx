...
export default function NewCreditNotePage() {
  ...
  const methods = useForm<InvoiceDocumentFormData>({
    ...
    defaultValues: createDefaultInvoiceFormData('CREDIT_NOTE'),
  });
  ...
  const onSubmit = async (data: InvoiceDocumentFormData) => {
    ...
    const handleAttemptComplete = async (result: SubmitAttemptResult) => {
      const attempt: AttemptEntry = {
        ...
        responseSummary: result.success ? 'Credit note submitted successfully' : result.error?.message,
    ...
    return (
      <div className="space-y-6">
        ...
        <Alert variant="warning">
          ...
          <AlertDescription>
            Please configure your seller identity in Settings before creating credit notes.
          </AlertDescription>
        </Alert>
    ...
    <div className="space-y-6">
      ...
      {submitSuccess && (
        <Alert variant="success">
          ...
          <AlertTitle>Credit Note Submitted Successfully</AlertTitle>
          <AlertDescription>
            Your credit note has been submitted to FBR. Redirecting to dashboard...
          </AlertDescription>
        </Alert>
      )}
